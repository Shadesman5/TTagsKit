!(function (t) {
  ...
  function (t, e, s) {
    (window.Extensions = _.merge(s(14), {
      name: "extensions",
      el: "#extensions",
    })),
  ...
  function (t, e) {
    e.compare = function (t, e, s) {
      ...
      var a,
        ...
        u = function (t) {
          return t ? (isNaN(t) ? o[t] || -7 : parseInt(t, 10)) : 0;
        };
      for (
        t = r(t), e = r(e), i = Math.max(t.length, e.length), a = 0;
        a < i;
        a++
      )
        if (t[a] != e[a]) {
          if (((t[a] = u(t[a])), (e[a] = u(e[a])), t[a] < e[a])) {
            n = -1;
            break;
          }
          if (t[a] > e[a]) {
  ...
  function (t, e, s) {
    t.exports = {
      ...
      watch: {
        search: function (t) {
          this.$session.set(this.$options.name + ".search", t);
        },
      },
      methods: {
        load: function () {
            ...
            this.packages &&
              this.queryUpdates(this.packages).then(
                function (t) {
                  ...
                  this.$set(
                    "updates",
                    e.packages.length ? _.indexBy(e.packages, "name") : null
                  ),
                    this.$set("status", "");
                },
                function () {
        ...
        icon: function (t) {
          return t.extra && t.extra.icon
            ? t.url + "/" + t.extra.icon
            : this.$url("app/system/assets/images/placeholder-icon.svg");
        },
        image: function (t) {
          return t.extra && t.extra.image
            ? t.url + "/" + t.extra.image
            : this.$url("app/system/assets/images/placeholder-800x600.svg");
        },
        details: function (t) {
          this.$set("package", t), this.$refs.details.open();
        },
        settings: function (t) {
          if (t.settings) {
            var e, s;
            _.forIn(this.$options.components, function (a, i) {
              (s = a.options || {}), s.settings && t.settings === i && (e = i);
            }),
              e
                ? (this.$set("package", t),
                  this.$set("view", e),
                  this.$refs.settings.open())
                : (window.location = t.settings);
          }
        },
      },
      filters: {
        empty: function (t) {
          return 0 === Vue.filter("filterBy")(t, this.search, "title").length;
        },
      },
      components: { "package-upload": s(19), "package-details": s(10) },
    };
  },
  function (t, e, s) {
    "use strict";
    ...
    t.exports = {
        ...
        image: function (t) {
          ...
          return e.image
            ? e.image.match(/^(https?:)?\//)
              ? e.image
              : t.url + "/" + e.image
            : this.$url("app/system/assets/images/placeholder-image.svg");
        },
      },
      watch: {
        package: {
          handler: function () {
            this["package"].name &&
              (_.isArray(this["package"].authors) &&
                (this["package"].author = this["package"].authors[0]),
              this.$set("messages", {}),
              this.queryPackage(this["package"], function (t) {
                var e = t.data,
                  s = this["package"].version,
                  i = e.versions[s];
                i &&
                  this["package"].shasum &&
                  this.$set(
                    "messages.checksum",
                    i.dist.shasum != this["package"].shasum
                  ),
                  _.each(e.versions, function (t) {
                    a.compare(t.version, s, ">") && (s = t.version);
                  }),
                  this.$set("messages.update", s != this["package"].version);
              }));
          },
          immediate: !0,
        },
      ...
      methods: {
        queryPackage: function (t, e) {
          return this.$http
            .get(this.api + "/api/package/{+name}", {
              name: _.isObject(t) ? t.name : t,
            })
            .then(e, this.error);
        },
      },
  ...
  function (t, e, s) {
    ...
    t.exports = {
      ...
      data: function () {
        return { package: {}, upload: null, progress: "" };
      },
      ready: function () {
        var t = this.type,
          e = {
            ...
            param: "file",
            before: function (e) {
              _.merge(e.params, { _csrf: $pagekit.csrf, type: t });
            },
            loadstart: this.onStart,
            progress: this.onProgress,
            allcomplete: this.onComplete,
          };
        UIkit.uploadSelect(this.$els.input, e),
      ...
      methods: {
        ...
        onComplete: function (t) {
          ...
          return (
            ...
            t["package"]
              ? (this.$set("upload", t),
                this.$set("package", t["package"]),
                void this.modal.show())
              : void this.$notify(t, "danger")
          );
        },
        doInstall: function () {
          this.modal.hide(),
