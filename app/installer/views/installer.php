            ...
            <div class="tm-container">
                ...
                <div class="uk-text-center" v-el:start v-show="step == 'start'">
                    ...
                    <a class="uk-panel" @click="gotoStep('language')">
                        <img style="width: 150px;" src="app/system/assets/images/ttags-logo.png" alt="TTAGS - Logo">
                        <p>
                        ...
                        <form class="uk-form uk-form-horizontal tm-form-horizontal" v-validator="formDatabase" @submit.prevent="stepDatabase | valid">
                            ...
                            <div class="uk-form-row" v-if="config.database.default == 'mysql'">
                                ...
                                <div class="uk-form-row">
                                    ...
                                    <div class="uk-form-controls">
                                        <input id="form-mysql-dbname" class="uk-width-1-1" type="text" name="dbname" value="ttags" v-model="config.database.connections.mysql.dbname" v-validate:required>
                                ...
                                <div class="uk-form-row">
                                    ...
                                    <div class="uk-form-controls">
                                        <input id="form-mysql-dbprefix" class="uk-width-1-1" type="text" name="mysqlprefix" value="tt_" v-model="config.database.connections.mysql.prefix" v-validate:pattern.literal="/^[a-zA-Z][a-zA-Z0-9._\-]*$/">
                            ...
                            <div class="uk-form-row" v-show="config.database.default == 'sqlite'">
                                <div class="uk-form-row">
                                    ...
                                    <div class="uk-form-controls">
                                        <input id="form-sqlite-dbprefix" class="uk-width-1-1" type="text" name="sqliteprefix" value="tt_" v-model="config.database.connections.sqlite.prefix" v-validate:pattern.literal="/^[a-zA-Z][a-zA-Z0-9._\-]*$/">
                    ...
                    <div v-pre>
                        ...
                        <form class="uk-form uk-form-horizontal tm-form-horizontal" v-validator="formSite" @submit.prevent="stepSite | valid">
                            ...
                            <div class="uk-form-row">
                                ...
                                <div class="uk-form-controls">
                                    <input id="form-username" class="uk-width-1-1" type="text" name="user" value="webmaster" v-model="user.username" v-validate:pattern.literal="/^[a-zA-Z0-9._\-]{3,}$/">
