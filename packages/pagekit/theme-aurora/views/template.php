    ...
    <body <?= $params['classes.body'] ?>>
        ...
        <div class="uk-grid tm-wrapper" uk-height-match>
            ...
            <div class="uk-width-1-1 tm-content-wrapper <?= ($params['totop_scroller'] || $view->menu()->exists('footer')) ? 'tm-footer-true' : '' ?>">
                ...
                <div class="tm-content-container uk-grid uk-grid-small" uk-grid data-uk-grid-margin data-uk-grid-match>
                    ...
                    <div id="tm-main" class="tm-main uk-width-1-1">

                        <!-- <div class="uk-grid uk-grid-small" uk-height-match v-for="listing in listings | orderBy 'position'" uk-grid>
                            <div class="uk-width-1-2">
                                <a class="uk-thumbnail" href="#">
                                    <span class="img-box">
                                        <img :src="listing.image" alt="{{listing.title}}" object-fit="cover">
                                    </span>
                ...
                <div id="tm-footer" class="tm-footer uk-text-center">
                    <section class="uk-grid" uk-grid>
                        <div class="uk-width-1-1">
                            <h3 class="uk-panel-title">Powered by <a href="https://www.ttags.de" target="_blank">TTAGS</a></h3>

                            <ul class="uk-grid uk-grid-medium uk-flex uk-flex-center uk-margin-medium-bottom">
                                <li>
                                    <a href="https://www.ttags.de" target="_blank" class="logo-small">
                                        <img src="storage/ttags-logo-50.png" alt="TTAGS Logo">
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.facebook.com/TTagsde-111228028042430" target="_blank" class="uk-icon-small uk-icon-facebook"></a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/ttags.de/" target="_blank" class="uk-icon-small uk-icon-instagram"></a>
                                </li>
                            </ul>
                            <hr>
                            <div class="uk-position-relative">
                                <p>
                                    <a href="https://ttags.de/impressum" target="_blank">Impressum</a> | 
                                    <a href="https://ttags.de/datenschutz" target="_blank">Datenschutz</a>
                                </p>
